              ...
              children: [
                ...
                pw.Row(
                  ...
                  children: [
                    ...
                    pw.Text(' $email',style: pw.TextStyle(color: PdfColors.grey900)),
                  ]
                ),
                ...
                pw.Row(
                    ...
                    pw.Row(
                        ...
                        children: [
                      pw.Text('Work\nExperience',style: kTitleTextStyle,textAlign: pw.TextAlign.right),
                    ]),
                    pw.SizedBox(
                      width: 75
                    ),
                    pw.Column(
                       ...
                       pw.Text('$compName1-$compLocation1',style: kSubTitleTextStyle),
                       pw.Text('$compStartDate1-$compEndDate1',style: pw.TextStyle(color: PdfColors.grey)),
                       pw.SizedBox(height: 5),
                       pw.Text('$summary1'),
                       pw.SizedBox(height: 10),
                       //company2
                        pw.Text('$jobTitle2',style: kSubTitleTextStyle),
                        pw.Text('$compName2-$compLocation2',style: kSubTitleTextStyle),
                        pw.Text('$compStartDate1-$compEndDate1',style: pw.TextStyle(color: PdfColors.grey)),
                        pw.SizedBox(height: 5),
                        pw.Text('$summary2'),
                        pw.SizedBox(height: 15),
                ...
                pw.Row(
                    ...
                    children: [
                      pw.Row(
                          ...
                          crossAxisAlignment: pw.CrossAxisAlignment.end,
                          children: [
                            pw.Text('  Education',style: kTitleTextStyle,textAlign: pw.TextAlign.right),
                          ]),
                      pw.SizedBox(
                          width: 75
                      ),
                      pw.Column(
                          ...
                          children: [
                            ...
                            pw.Text('$course - $edLocation1',style: kSubTitleTextStyle),
                            pw.Text('$eddate1',style: pw.TextStyle(color: PdfColors.grey)),
                            pw.SizedBox(height: 5),
                            pw.Text('$edSummary1,'),
                            pw.SizedBox(height: 10),
                            //company2
                            pw.Text('$instname2',style: kSubTitleTextStyle),
                            pw.Text('$course2 - $edLocation2',style: kSubTitleTextStyle),
                            pw.Text('$eddate2',style: pw.TextStyle(color: PdfColors.grey)),
                            pw.SizedBox(height: 5),
                            pw.Text('$edSummary2'),
                            pw.SizedBox(height: 15),
                          ]),
                ...
                pw.Row(
                    ...
                    children: [
                      pw.Row(
                          ...
                          crossAxisAlignment: pw.CrossAxisAlignment.end,
                          children: [
                            pw.Text('         Skills',style: kTitleTextStyle,textAlign: pw.TextAlign.right),
                          ]),
                      pw.SizedBox(
                          width: 75
                      ),
                ...
                pw.Row(
                    ...
                    children: [
                      pw.Row(
                          ...
                          crossAxisAlignment: pw.CrossAxisAlignment.end,
                          children: [
                            pw.Text('     Projects',style: kTitleTextStyle,textAlign: pw.TextAlign.right),
                          ]),
                      pw.SizedBox(
                          width: 75
                      ),
