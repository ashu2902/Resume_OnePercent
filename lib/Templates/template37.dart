                ...
                children: [
                  ...
                  pw.Expanded(
                    ...
                    child: pw.Column(
                      ...
                      children: [
                        pw.Text('info'.toUpperCase(),
                            style:kTitleTextstyle ),
                        pw.Container(width: 30,child: pw.Divider(thickness: 2,color: PdfColors.green900),),
                        ...
                        pw.Container(width: 30,child: pw.Divider(thickness: 2,color: PdfColors.green900),),
                        pw.SizedBox(height: 15),
                        pw.Bullet(text:'$lang1',style: kSubTitleTextstyle),
                        pw.SizedBox(height: 5),
                        pw.Bullet(text:'$lang2',style: kSubTitleTextstyle),
                      ],
                    ),
                  ),
