...
class Template45 {
  ...
  static pw.Row EducationDetails(String university, String course, String date,
        ...
        build: (context) => pw.Column(
          ...
          children: [
            ...
            ExperienceDetails(jobTitle1, company1, companyStartDate1,
                companyEndDate1, jobSummary1, jobLocation1),
            kSpace,
            ExperienceDetails(jobTitle2, company2, companyStartDate2,
                companyEndDate2, jobSummary2, jobLocation2),
            kSpace,
            Title('Education'),
            kSpace,
            EducationDetails(
                university1, course1, edDate1, edSummary1, edLocation1),
            kSpace,
            EducationDetails(
                university2, course2, edDate2, edSummary2, edLocation2),
            kSpace,
            Title('Skills'),
            kSpace,
            pw.Column(
