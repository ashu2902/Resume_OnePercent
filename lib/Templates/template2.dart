      ...
      pw.Column(
          children: [
            pw.Container(  alignment: pw.Alignment.centerRight,
              child: pw.Text(name, style: pw.TextStyle(fontSize: 30)),),  //add color
            pw.Container( alignment: pw.Alignment.centerRight,
           ...
           pw.Column(
             ...
             children: [
              ...
              pw.Container(
                ...
                child: pw.Text('Objectives',style: pw.TextStyle(fontSize: 20)),
              ),
               pw.Container(
              ...
              pw.SizedBox(height: 20),
               ...
               pw.Container(
                 alignment: pw.Alignment.topLeft,
                 child: pw.Text('Experience',style: pw.TextStyle(fontSize: 20)),
               ),
               pw.SizedBox(height: 10),
               // company 1
               pw.Container( child: pw.Text(companyname1 +',' + location1)),
               pw.Container( child: pw.Text(startdate1 + '-' + enddate1)),
               pw.Container( child: pw.Text('[This is the place for a brief summary of your key responsibilites and accomplishments.]')),
               pw.SizedBox(height: 10),
               // company 2
               ...
               pw.SizedBox(height: 10),
               pw.Container( child: pw.Text("[$schoolname+','+$slocation+','+$sdegree]")),
