          ...
          pw.Column(
              ...
              children: [
                pw.Container(
                    ...
                    child: pw.Text('About', style: pw.TextStyle(fontSize: 18))),
  ...
  Widget build(BuildContext context) {
    return Scaffold(
        floatingActionButton:
            FloatingActionButton.extended(onPressed: null, label: Text('Save')),
        body: Container(child:
        isPathAvailable ? PdfViewer.openFile(path) : Text('Loading')));
  }
}
