                  ...
                  children: [
                    ...
                    pw.Container(
                      child: pw.Text(
                        '   $name',
                        style: pw.TextStyle(
                          fontWeight: pw.FontWeight.bold,color: PdfColors.lightBlue600,
                          fontSize: 30,
                        ),
                      ),
                    ),
                    ...
                    //Profile
                    pw.Divider(color: PdfColors.lightBlue600,thickness: 1),
                    pw.Container(
                      child: pw.Text(
                      'ABOUT ME',
                        style: kTitleTextStyle.copyWith(color: PdfColors.lightBlue600),
                      ),
                    ),
                    pw.Divider(color: PdfColors.lightBlue600,thickness: 1),
                    ...
                    pw.Container(
                      child: pw.Text(
                          'CONTACT', style: kTitleTextStyle.copyWith(color: PdfColors.lightBlue600)),
                    ),
                    pw.Divider(color: PdfColors.lightBlue600,thickness: 1),
                    pw.SizedBox(height: 10),
                    pw.Container(
